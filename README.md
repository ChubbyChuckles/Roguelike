...
* Phase 5.7 (partial): Added latency & obstruction interaction test (`test_combat_phase5_lock_on_obstruction_latency`) validating lock-on switch cooldown gating and obstruction attenuation under assist (ratio asserted 55-65%). Remaining: multi-target angular ordering damage assist test.
