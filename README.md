...
* Phase 5.7 (partial): Added latency & obstruction interaction test (`test_combat_phase5_lock_on_obstruction_latency`) validating lock-on switch cooldown gating and that obstruction attenuation still applies under directional assist. Remaining work: stabilize baseline damage for stricter attenuation ratio assertion.
