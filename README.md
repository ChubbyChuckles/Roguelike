...
CI runs Debug and Release with SDL2 enabled and parallel ctest. Recent additions include Phase 5.2 JSON integration tests for vendor inventory and loot generation. Total tests now: 675 (Debug/Release). More JSON integration tests (crafting/equipment/inventory) will land next.
