...
CI runs Debug and Release with SDL2 enabled and parallel ctest. Recent additions include Phase 5.2 JSON integration tests for vendor inventory and loot generation, crafting, equipment persistence, and inventory operations. Total tests now: 678 (Debug/Release).
