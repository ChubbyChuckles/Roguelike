...
* Combat Attack Registry (Phase 1.1–1.3 partial): Added classless weapon archetypes (light, heavy, thrust, ranged, spell_focus) with data-driven (static for now) attack chains and validation test (`test_combat_attack_registry`). Forms foundation for timing, branching & future external authoring.
