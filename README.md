...
* Phase 3.11 Test Expansion: Added hyper armor poise immunity test (`test_combat_phase3_hyper_armor_immunity`); guard block test covers cone + perfect window; remaining future tests: precise cone edge tolerance & authored hyper armor windows.
