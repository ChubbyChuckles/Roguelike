...
* NEW: Crafting & Gathering Phase 9 – Automation & Smart Assist: Added `crafting_automation.[ch]` (planner, route suggestion, auto-refine, decision score, idle recommendation) with deterministic analytics helpers and unit test `test_crafting_phase9_automation` (CRAFT_P9_OK) ensuring planner determinism, non-negative projections, refine suggestion validity, and decision score ordering.
