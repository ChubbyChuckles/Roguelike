...
- Roadmap alignment: marks preloading, lazy loading, and profiling tasks complete; streaming, cross‑platform load optimizations, and atlas tooling remain pending.
