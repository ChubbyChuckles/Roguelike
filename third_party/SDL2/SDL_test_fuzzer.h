...
extern "C"
{
    ...
    */
     ...
     * RandomSint8BoundaryValue(SINT8_MIN, SINT8_MAX, SDL_FALSE) returns SINT8_MIN (== error value)
     * with error set
     *
     * \param boundary1 Lower boundary limit
     * \param boundary2 Upper boundary limit
     ...
     * RandomSint16BoundaryValue(SINT16_MIN, SINT16_MAX, SDL_FALSE) returns SINT16_MIN (== error
     ...
     * RandomSint32BoundaryValue(SINT32_MIN, SINT32_MAX, SDL_FALSE) returns SINT32_MIN (== error
     * value)
     *
     * \param boundary1 Lower boundary limit
     * \param boundary2 Upper boundary limit
     ...
     * RandomSint64BoundaryValue(SINT64_MIN, SINT64_MAX, SDL_FALSE) returns SINT64_MIN (== error
     * value) and error set
     *
     * \param boundary1 Lower boundary limit
     * \param boundary2 Upper boundary limit
     ...
     *
     * \returns a newly allocated random string; or NULL if length was invalid or string could not
     * be allocated.
     */
     ...
     *
     * \returns a newly allocated random string; or NULL if maxLength was invalid or string could
     * not be allocated.
     */
