...
static void test_bridge_initialization(void)
{
    ...
    TEST_ASSERT(bridge.seasonal_system.current_season == SEASON_SPRING, "Default season is spring");
...
static void test_placement_rule_loading(void)
{
    ...
    TEST_ASSERT(placement->resource_types[0] == RESOURCE_STONE, "First resource type is stone");
...
static void test_quality_calculation(void)
{
    ...
    TEST_ASSERT(rogue_worldgen_resource_bridge_calculate_resource_quality(&bridge, 999,
                                                                          RESOURCE_STONE) == 1,
