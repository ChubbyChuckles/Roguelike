...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_geometry.c AND NOT TARGET test_hit_geometry)
    ...
    rogue_add_test(NAME test_hit_geometry COMMAND test_hit_geometry)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_sweep_normals.c AND NOT TARGET test_hit_sweep_normals)
    ...
    rogue_add_test(NAME test_hit_sweep_normals COMMAND test_hit_sweep_normals)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_phase4_feedback.c AND NOT TARGET test_hit_phase4_feedback)
    ...
    rogue_add_test(NAME test_hit_phase4_feedback COMMAND test_hit_phase4_feedback)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_phase6_debug_toggle.c AND NOT TARGET test_hit_phase6_debug_toggle)
    ...
    rogue_add_test(NAME test_hit_phase6_debug_toggle COMMAND test_hit_phase6_debug_toggle)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_mask_basic.c AND NOT TARGET test_hit_mask_basic)
    ...
    rogue_add_test(NAME test_hit_mask_basic COMMAND test_hit_mask_basic)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_mask_mismatch.c AND NOT TARGET test_hit_mask_mismatch)
    ...
    rogue_add_test(NAME test_hit_mask_mismatch COMMAND test_hit_mask_mismatch)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hit_phase7_integration.c AND NOT TARGET test_hit_phase7_integration)
    ...
    rogue_add_test(NAME test_hit_phase7_integration COMMAND test_hit_phase7_integration)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_hitbox_directory_load.c AND NOT TARGET test_hitbox_directory_load)
    ...
    rogue_add_test(NAME test_hitbox_directory_load COMMAND test_hitbox_directory_load)
endif()
...
# Collision pipeline SIMD micro-benchmark (prints timings; always exits 0)
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_collision_pipeline_simd_microbench.c AND NOT TARGET test_collision_pipeline_simd_microbench)
    add_executable(test_collision_pipeline_simd_microbench unit/test_collision_pipeline_simd_microbench.c)
    target_link_libraries(test_collision_pipeline_simd_microbench PRIVATE rogue_core)
    if(ROGUE_ENABLE_SDL)
        target_compile_definitions(test_collision_pipeline_simd_microbench PRIVATE ROGUE_HAVE_SDL=1)
    endif()
