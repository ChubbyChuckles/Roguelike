...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_start_screen_phase10_6_corrupt_header.c AND NOT TARGET test_start_screen_phase10_6_corrupt_header)
    ...
    target_link_libraries(test_start_screen_phase10_6_corrupt_header PRIVATE rogue_core)
    if(TARGET SDL2::SDL2)
        target_link_libraries(test_start_screen_phase10_6_corrupt_header PRIVATE SDL2::SDL2)
        target_compile_definitions(test_start_screen_phase10_6_corrupt_header PRIVATE ROGUE_HAVE_SDL=1 SDL_MAIN_HANDLED=1)
    else()
        target_compile_definitions(test_start_screen_phase10_6_corrupt_header PRIVATE SDL_MAIN_HANDLED=1)
    endif()
    add_test(NAME test_start_screen_phase10_6_corrupt_header COMMAND test_start_screen_phase10_6_corrupt_header)
endif()
