...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/../unit/test_cfg_parser.c)
    ...
    rogue_add_test(NAME test_cfg_parser COMMAND test_cfg_parser)
endif()
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/../unit/test_cfg_migration.c)
    ...
    rogue_add_test(NAME test_cfg_migration COMMAND test_cfg_migration)
endif()
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/../unit/test_config_version.c)
    ...
    rogue_add_test(NAME test_config_version COMMAND test_config_version)
endif()
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/../unit/test_config_system_validation.c)
    ...
    rogue_add_test(NAME test_config_system_validation COMMAND test_config_system_validation)
endif()
