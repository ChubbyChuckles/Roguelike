...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase5_sockets.c AND NOT TARGET test_equipment_phase5_sockets)
    ...
    rogue_add_test(NAME test_equipment_phase5_sockets COMMAND test_equipment_phase5_sockets)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase5_gems.c AND NOT TARGET test_equipment_phase5_gems)
    ...
    rogue_add_test(NAME test_equipment_phase5_gems COMMAND test_equipment_phase5_gems)
    ...
    rogue_add_test(NAME test_equipment_phase5_enchant_reforge COMMAND test_equipment_phase5_enchant_reforge)
    ...
    rogue_add_test(NAME test_equipment_phase5_protective_seal COMMAND test_equipment_phase5_protective_seal)
    ...
    rogue_add_test(NAME test_equipment_phase6_proc_engine COMMAND test_equipment_phase6_proc_engine)
    ...
    rogue_add_test(NAME test_equipment_phase6_proc_engine_extended COMMAND test_equipment_phase6_proc_engine_extended)
    ...
    rogue_add_test(NAME test_equipment_phase7_defensive COMMAND test_equipment_phase7_defensive)
    ...
    rogue_add_test(NAME test_equipment_phase7_block_affixes COMMAND test_equipment_phase7_block_affixes)
    ...
    rogue_add_test(NAME test_equipment_phase7_conversion_reflect COMMAND test_equipment_phase7_conversion_reflect)
    ...
    rogue_add_test(NAME test_equipment_phase7_affix_parsing_newstats COMMAND test_equipment_phase7_affix_parsing_newstats)
    ...
    rogue_add_test(NAME test_equipment_phase7_reactive_shield COMMAND test_equipment_phase7_reactive_shield)
    ...
    rogue_add_test(NAME test_equipment_phase8_durability_model COMMAND test_equipment_phase8_durability_model)
    ...
    rogue_add_test(NAME test_equipment_phase8_repair_cost COMMAND test_equipment_phase8_repair_cost)
    ...
    rogue_add_test(NAME test_equipment_phase8_salvage_fracture COMMAND test_equipment_phase8_salvage_fracture)
    ...
    rogue_add_test(NAME test_equipment_phase9_loadout_opt COMMAND test_equipment_phase9_loadout_opt)
    ...
    rogue_add_test(NAME test_equipment_phase10_quality COMMAND test_equipment_phase10_quality)
    ...
    rogue_add_test(NAME test_equipment_phase10_crafting COMMAND test_equipment_phase10_crafting)
    ...
    rogue_add_test(NAME test_equipment_phase10_crafting_success COMMAND test_equipment_phase10_crafting_success)
    ...
    rogue_add_test(NAME test_equipment_phase11_analytics COMMAND test_equipment_phase11_analytics)
    ...
    rogue_add_test(NAME test_equipment_phase11_balance COMMAND test_equipment_phase11_balance)
    ...
    rogue_add_test(NAME test_equipment_phase12_ui COMMAND test_equipment_phase12_ui)
    ...
    rogue_add_test(NAME test_equipment_phase13_persistence COMMAND test_equipment_phase13_persistence)
        ...
        if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase18_stress_combo.c AND NOT TARGET test_equipment_phase18_stress_combo)
            ...
            rogue_add_test(NAME test_equipment_phase18_stress_combo COMMAND test_equipment_phase18_stress_combo)
        ...
        if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase18_mutation.c AND NOT TARGET test_equipment_phase18_mutation)
            ...
            rogue_add_test(NAME test_equipment_phase18_mutation COMMAND test_equipment_phase18_mutation)
    ...
    rogue_add_test(NAME test_equipment_phase16_itemdefs_json COMMAND test_equipment_phase16_itemdefs_json)
    ...
    rogue_add_test(NAME test_equipment_phase16_set_builder COMMAND test_equipment_phase16_set_builder)
    ...
    rogue_add_test(NAME test_equipment_phase16_proc_designer COMMAND test_equipment_phase16_proc_designer)
    ...
    rogue_add_test(NAME test_equipment_phase16_runeword_validator COMMAND test_equipment_phase16_runeword_validator)
    ...
    rogue_add_test(NAME test_equipment_phase16_budget_analyzer COMMAND test_equipment_phase16_budget_analyzer)
    ...
    rogue_add_test(NAME test_equipment_phase16_analyzer_boundaries COMMAND test_equipment_phase16_analyzer_boundaries)
    ...
    rogue_add_test(NAME test_equipment_phase17_schema_docs COMMAND test_equipment_phase17_schema_docs)
        set_tests_properties(test_equipment_phase17_schema_docs PROPERTIES WORKING_DIRECTORY ${CMAKE_SOURCE_DIR})
            ...
            rogue_add_test(NAME test_equipment_phase17_hot_reload COMMAND test_equipment_phase17_hot_reload)
            ...
            rogue_add_test(NAME test_equipment_phase17_hot_reload_hash COMMAND test_equipment_phase17_hot_reload_hash)
            ...
            rogue_add_test(NAME test_equipment_phase17_sandbox_script COMMAND test_equipment_phase17_sandbox_script)
            ...
            rogue_add_test(NAME test_equipment_phase17_sets_diff COMMAND test_equipment_phase17_sets_diff)
            ...
            rogue_add_test(NAME test_equipment_phase18_snapshot COMMAND test_equipment_phase18_snapshot)
            ...
            rogue_add_test(NAME test_equipment_phase18_fuzz COMMAND test_equipment_phase18_fuzz)
            ...
            rogue_add_test(NAME test_equipment_phase18_proc_stats COMMAND test_equipment_phase18_proc_stats)
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase13_slot_migration.c AND NOT TARGET test_equipment_phase13_slot_migration)
    ...
    rogue_add_test(NAME test_equipment_phase13_slot_migration COMMAND test_equipment_phase13_slot_migration)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase14_parallel.c AND NOT TARGET test_equipment_phase14_parallel)
    ...
    rogue_add_test(NAME test_equipment_phase14_parallel COMMAND test_equipment_phase14_parallel)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase15_integrity.c AND NOT TARGET test_equipment_phase15_integrity)
    ...
    rogue_add_test(NAME test_equipment_phase15_integrity COMMAND test_equipment_phase15_integrity)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase15_replay_auditor.c AND NOT TARGET test_equipment_phase15_replay_auditor)
    ...
    rogue_add_test(NAME test_equipment_phase15_replay_auditor COMMAND test_equipment_phase15_replay_auditor)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase14_extended.c AND NOT TARGET test_equipment_phase14_extended)
    ...
    rogue_add_test(NAME test_equipment_phase14_extended COMMAND test_equipment_phase14_extended)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase14_perf.c AND NOT TARGET test_equipment_phase14_perf)
    ...
    rogue_add_test(NAME test_equipment_phase14_perf COMMAND test_equipment_phase14_perf)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase1_slots.c AND NOT TARGET test_equipment_phase1_slots)
    ...
    rogue_add_test(NAME test_equipment_phase1_slots COMMAND test_equipment_phase1_slots)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase1_transmog.c AND NOT TARGET test_equipment_phase1_transmog)
    ...
    rogue_add_test(NAME test_equipment_phase1_transmog COMMAND test_equipment_phase1_transmog)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase1_persistence.c AND NOT TARGET test_equipment_phase1_persistence)
    ...
    rogue_add_test(NAME test_equipment_phase1_persistence COMMAND test_equipment_phase1_persistence)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase2_stat_cache.c AND NOT TARGET test_equipment_phase2_stat_cache)
    ...
    rogue_add_test(NAME test_equipment_phase2_stat_cache COMMAND test_equipment_phase2_stat_cache)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase2_affix_layers.c AND NOT TARGET test_equipment_phase2_affix_layers)
    ...
    rogue_add_test(NAME test_equipment_phase2_affix_layers COMMAND test_equipment_phase2_affix_layers)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase2_4_stat_aggregation_parity.c AND NOT TARGET test_equipment_phase2_4_stat_aggregation_parity)
    add_executable(test_equipment_phase2_4_stat_aggregation_parity unit/test_equipment_phase2_4_stat_aggregation_parity.c)
    target_link_libraries(test_equipment_phase2_4_stat_aggregation_parity PRIVATE rogue_core)
    if(ROGUE_ENABLE_SDL)
        target_compile_definitions(test_equipment_phase2_4_stat_aggregation_parity PRIVATE ROGUE_HAVE_SDL=1)
    endif()
    rogue_add_test(NAME test_equipment_phase2_4_stat_aggregation_parity COMMAND test_equipment_phase2_4_stat_aggregation_parity)
endif()
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase2_resists.c AND NOT TARGET test_equipment_phase2_resists)
    ...
    rogue_add_test(NAME test_equipment_phase2_resists COMMAND test_equipment_phase2_resists)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase3_budget.c AND NOT TARGET test_equipment_phase3_budget)
    ...
    rogue_add_test(NAME test_equipment_phase3_budget COMMAND test_equipment_phase3_budget)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase4_1_implicits.c AND NOT TARGET test_equipment_phase4_1_implicits)
    ...
    rogue_add_test(NAME test_equipment_phase4_1_implicits COMMAND test_equipment_phase4_1_implicits)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase4_2_uniques.c AND NOT TARGET test_equipment_phase4_2_uniques)
    ...
    rogue_add_test(NAME test_equipment_phase4_2_uniques COMMAND test_equipment_phase4_2_uniques)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_phase4_3_5_sets_runewords.c AND NOT TARGET test_equipment_phase4_3_5_sets_runewords)
    ...
    rogue_add_test(NAME test_equipment_phase4_3_5_sets_runewords COMMAND test_equipment_phase4_3_5_sets_runewords)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_stat_bonus.c AND NOT TARGET test_equipment_stat_bonus)
    ...
    rogue_add_test(NAME test_equipment_stat_bonus COMMAND test_equipment_stat_bonus)
endif()
...
if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/unit/test_equipment_unequip_delta.c AND NOT TARGET test_equipment_unequip_delta)
    ...
    rogue_add_test(NAME test_equipment_unequip_delta COMMAND test_equipment_unequip_delta)
endif()
