...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase6_1_4_music_system.c)
    add_executable(test_audio_vfx_phase6_1_4_music_system unit/test_audio_vfx_phase6_1_4_music_system.c)
    target_link_libraries(test_audio_vfx_phase6_1_4_music_system PRIVATE rogue_audio_vfx)
    if(ROGUE_ENABLE_SDL AND TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase6_2_beat_aligned.c)
    add_executable(test_audio_vfx_phase6_2_beat_aligned unit/test_audio_vfx_phase6_2_beat_aligned.c)
    target_link_libraries(test_audio_vfx_phase6_2_beat_aligned PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase6_4_music_layering.c)
    add_executable(test_audio_vfx_phase6_4_music_layering unit/test_audio_vfx_phase6_4_music_layering.c)
    target_link_libraries(test_audio_vfx_phase6_4_music_layering PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase7_core.c)
    add_executable(test_audio_vfx_phase7_core unit/test_audio_vfx_phase7_core.c)
    target_link_libraries(test_audio_vfx_phase7_core PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase7_3_5_7_trails_post_decals.c)
    add_executable(test_audio_vfx_phase7_3_5_7_trails_post_decals unit/test_audio_vfx_phase7_3_5_7_trails_post_decals.c)
    target_link_libraries(test_audio_vfx_phase7_3_5_7_trails_post_decals PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase8_1_2_3_4_profiler_budgets_pacing_audit.c)
    add_executable(test_audio_vfx_phase8_1_2_3_4_profiler_budgets_pacing_audit unit/test_audio_vfx_phase8_1_2_3_4_profiler_budgets_pacing_audit.c)
    target_link_libraries(test_audio_vfx_phase8_1_2_3_4_profiler_budgets_pacing_audit PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase8_5_stress_100_impacts.c)
    add_executable(test_audio_vfx_phase8_5_stress_100_impacts unit/test_audio_vfx_phase8_5_stress_100_impacts.c)
    target_link_libraries(test_audio_vfx_phase8_5_stress_100_impacts PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase9_1_ordering_tuple.c)
    add_executable(test_audio_vfx_phase9_1_ordering_tuple unit/test_audio_vfx_phase9_1_ordering_tuple.c)
    target_link_libraries(test_audio_vfx_phase9_1_ordering_tuple PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
...
if(EXISTS ${CMAKE_CURRENT_LIST_DIR}/unit/test_audio_vfx_phase9_2_replay_and_hash.c)
    add_executable(test_audio_vfx_phase9_2_replay_and_hash unit/test_audio_vfx_phase9_2_replay_and_hash.c)
    target_link_libraries(test_audio_vfx_phase9_2_replay_and_hash PRIVATE rogue_audio_vfx)
    if(TARGET SDL2::SDL2)
