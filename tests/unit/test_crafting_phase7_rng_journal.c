...
int main(void)
{
    ...
    /* streams must be independent: a != b and advancing gathering again not equal to previous
     * refinement sample typically */
    if (a == b)
    {
        fprintf(stderr, "P7_FAIL stream_independence\n");
        return 10;
    }
