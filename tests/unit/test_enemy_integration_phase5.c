...
static void test_spawn_position_solver_basic() {
    ...
    int result = rogue_enemy_integration_solve_spawn_positions(&encounter_info, &room_dims, &solution);
...
static void test_spawn_position_solver_boss() {
    ...
    float dist_to_center = sqrtf((boss_x - center_x)*(boss_x - center_x) + (boss_y - center_y)*(boss_y - center_y));
...
static void test_spawn_position_solver_obstacles() {
    ...
    /* Add obstacle zones */
    room_dims.obstacle_zones[0][0] = 2.0f; room_dims.obstacle_zones[0][1] = 2.0f;
    room_dims.obstacle_zones[0][2] = 4.0f; room_dims.obstacle_zones[0][3] = 4.0f;
    
    room_dims.obstacle_zones[1][0] = 5.0f; room_dims.obstacle_zones[1][1] = 5.0f;
    room_dims.obstacle_zones[1][2] = 7.0f; room_dims.obstacle_zones[1][3] = 7.0f;
...
static void test_navmesh_registration() {
    ...
    solution.positions[0][0] = 2.0f; solution.positions[0][1] = 2.0f;
    solution.positions[1][0] = 5.0f; solution.positions[1][1] = 5.0f;
    solution.positions[2][0] = 8.0f; solution.positions[2][1] = 8.0f;
    solution.success = 1;
...
static void test_enemy_placement_finalization() {
    ...
    solution.positions[0][0] = 3.0f; solution.positions[0][1] = 4.0f;
    solution.positions[1][0] = 7.0f; solution.positions[1][1] = 6.0f;
    solution.success = 1;
...
static void test_deterministic_spawn_behavior() {
    ...
    srand(42);
    int result1 = rogue_enemy_integration_solve_spawn_positions(&encounter_info, &room_dims, &solution1);
    
    srand(42);
    int result2 = rogue_enemy_integration_solve_spawn_positions(&encounter_info, &room_dims, &solution2);
