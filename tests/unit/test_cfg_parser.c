...
static void create_test_item_file(const char* filename) {
    ...
    fprintf(file, "# id,name,category,level_req,stack_max,base_value,dmg_min,dmg_max,armor,sheet,tx,ty,tw,th,rarity\n");
    fprintf(file, "# categories: 0=misc 1=consumable 2=weapon 3=armor 4=gem 5=material\n");
    fprintf(file, "gold_coin,Gold Coin,0,0,100,1,0,0,0,../assets/biomes/default/Props/Static/Resources.png, 6, 1, 1, 1,0\n");
    fprintf(file, "bandage,Bandage,1,0,10,5,0,0,0,../assets/biomes/default/Props/Static/Resources.png, 5, 1, 1, 1,0\n");
    fprintf(file, "long_sword,Long Sword,2,1,1,25,3,7,0,../assets/biomes/default/Props/Static/Resources.png, 4, 1, 1, 1,1\n");
...
static void test_utility_functions(void) {
    ...
    assert(strcmp(rogue_cfg_category_to_string(ROGUE_CFG_CATEGORY_LOOT_TABLES), "Loot Tables") == 0);
