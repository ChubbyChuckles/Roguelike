...
int main(){
    reset_app_state();
    RoguePlayer player; rogue_player_init(&player); player.strength=30; player.base.pos.x=0; player.base.pos.y=0; player.facing=2;
    RogueEnemy enemy; enemy.alive=1; enemy.base.pos.x=1.2f; enemy.base.pos.y=0; enemy.health=500; enemy.max_health=500;
