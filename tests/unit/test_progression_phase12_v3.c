...
int main(void){
    ...
    /* seed state */
    g_app.level=22; g_app.xp_total_accum=77777ull; g_app.unspent_stat_points=5;
    g_attr_state.strength=2; g_attr_state.dexterity=1; g_attr_state.vitality=0; g_attr_state.intelligence=0; g_attr_state.spent_points=0; g_attr_state.respec_tokens=1; g_attr_state.journal_hash=0xcbf29ce484222325ULL; g_attr_state.ops=NULL; g_attr_state.op_count=0; g_attr_state.op_cap=0;
    ...
    /* wipe and restore */
    g_app.level=1; g_app.xp_total_accum=0; g_attr_state.strength=0; g_attr_state.dexterity=0; g_attr_state.vitality=0; g_attr_state.intelligence=0; g_attr_state.spent_points=0; g_attr_state.respec_tokens=0; g_attr_state.op_count=0; g_attr_state.op_cap=0; if(g_attr_state.ops){ free(g_attr_state.ops); g_attr_state.ops=NULL; }
    fseek(f,0,SEEK_SET);
