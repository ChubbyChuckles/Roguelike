...
int main(void)
{
    ...
    const char* v1 = "[ { \"set_id\": 101, \"bonuses\": [ { \"pieces\":2, \"strength\":5 }, { "
                     "\"pieces\":4, \"strength\":10 } ] } ]";
    const char* v2 = "[ { \"set_id\": 101, \"bonuses\": [ { \"pieces\":2, \"strength\":5 }, { "
                     "\"pieces\":4, \"strength\":10 } ] }, { \"set_id\": 202, \"bonuses\": [ { "
                     "\"pieces\":3, \"dexterity\":7 } ] } ]";
    ...
    const RogueSetDef* s1 = rogue_set_find(101);
    ck(s1 && s1->bonus_count == 2, "set 101 present w/2 bonuses");
