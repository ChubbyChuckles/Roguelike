...
int main(void){
    ...
    if(frame<4) printf("f%d player=(%d,%d) enemy_tile=(%d,%d)\n",frame,ptx,pty,(int)(e->base.pos.x+0.5f),(int)(e->base.pos.y+0.5f));
    ...
    if(!observed_advance){ printf("no_movement ex=%f ey=%f p=(%d,%d)\n", e->base.pos.x,e->base.pos.y,px,py); return 7; }
