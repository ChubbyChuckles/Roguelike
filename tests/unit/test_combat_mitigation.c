...
static int strike_once_vs_enemy(int armor,int rphys,int resist_fire,int resist_frost,int resist_arcane,int raw_expect_less_than_raw){
    ...
    RogueEnemy e; e.alive=1; e.base.pos.x=1.0f; e.base.pos.y=0; e.health=10000; e.max_health=10000; e.armor=armor; e.resist_physical=rphys; e.resist_fire=resist_fire; e.resist_frost=resist_frost; e.resist_arcane=resist_arcane;
