...
static void test_enemy_at_position_search(void) {
    ...
    int enemy_id = rogue_enemy_integration_register_enemy(&registry, 1, 100, enemy_pos, &display_info);
...
static void test_damage_application(void) {
    ...
    int damage_result = rogue_enemy_integration_apply_damage(&registry, enemy_id, 60.0f, 0); /* physical */
...
static void test_position_updates(void) {
    ...
    int enemy_id = rogue_enemy_integration_register_enemy(&registry, 1, 100, initial_pos, &display_info);
...
static void test_display_info_retrieval(void) {
    ...
    strcpy_s(original_display.modifier_tags[1], sizeof(original_display.modifier_tags[1]), "armored");
    
    float pos[2] = {0.0f, 0.0f};
    int enemy_id = rogue_enemy_integration_register_enemy(&registry, 1, 100, pos, &original_display);
...
static void test_error_handling_edge_cases(void) {
    ...
    assert(rogue_enemy_integration_apply_damage(&registry, enemy_id, -10.0f, 0) == 0); /* Negative damage */
