...
/* Enhanced harness: validates parser ingestion of socket_min/max columns, deterministic fixed count, range bounds, and insert/remove semantics. */
int main(void){
    ...
    /* Spawn multiple instances of range item at varying positions to exercise LCG variance inside [2,4]. */
