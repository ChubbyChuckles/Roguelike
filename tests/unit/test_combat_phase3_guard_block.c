...
int main(){
    ...
    int dmg_full = 100;
    int applied = rogue_player_apply_incoming_melee(&p, (float)dmg_full, 0.0f, 1.0f, &blocked, &perfect);
    assert(blocked==1);
    ...
    blocked=0; perfect=0;
    int applied2 = rogue_player_apply_incoming_melee(&p, (float)dmg_full, 0.0f, 1.0f, &blocked, &perfect);
    ...
    blocked=0; perfect=0;
    int applied3 = rogue_player_apply_incoming_melee(&p, (float)dmg_full, 0.0f, -1.0f, &blocked, &perfect);
