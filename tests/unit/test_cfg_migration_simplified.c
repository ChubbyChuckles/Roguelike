...
static void create_test_items_cfg(void)
{
    ...
    fprintf(f, "# "
               "id,name,category,level_req,stack_max,base_value,dmg_min,dmg_max,armor,sheet,tx,ty,"
               "tw,th,rarity\n");
    fprintf(f, "iron_sword,Iron Sword,2,1,1,25,3,7,0,../assets/weapons/sword.png,0,0,32,32,1\n");
    fprintf(
        f, "healing_potion,Healing Potion,1,0,20,5,0,0,0,../assets/items/potion.png,0,0,16,16,0\n");
    fprintf(f,
            "leather_armor,Leather Armor,3,1,1,15,0,0,5,../assets/armor/leather.png,0,0,32,32,0\n");
