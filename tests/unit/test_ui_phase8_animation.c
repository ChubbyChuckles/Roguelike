...
{
    RogueUIContext ctx;
    RogueUIContextConfig cfg = {128, 42, 16 * 1024};
    ...
    int b = rogue_ui_button(&ctx, r, "AnimBtn", 0x202020FF, 0xFFFFFFFF);
    if (b < 0)
    {
