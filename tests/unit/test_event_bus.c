...
static bool test_event_predicate(const RogueEvent* event) {
    return g_test_predicate_result;
}
...
static bool test_event_publishing(void) {
    ...
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload, 
                              ROGUE_EVENT_PRIORITY_NORMAL, 1, "TestSystem") == true);
    ...
    assert(rogue_event_publish_with_deadline(ROGUE_EVENT_PLAYER_MOVED, &payload,
                                            ROGUE_EVENT_PRIORITY_HIGH, deadline,
                                            2, "PlayerSystem") == true);
    ...
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, NULL, 
                              ROGUE_EVENT_PRIORITY_NORMAL, 1, "TestSystem") == false);
    
    /* Test invalid priority rejection */
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload, 
                              (RogueEventPriority)999, 1, "TestSystem") == false);
...
static bool test_event_subscription_basic(void) {
    ...
    uint32_t sub_id = rogue_event_subscribe(ROGUE_EVENT_ENTITY_CREATED,
                                           test_event_callback_basic,
                                           &test_value, 1);
    assert(sub_id != 0);
    ...
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_NORMAL, 2, "Publisher") == true);
...
static bool test_event_subscription_conditional(void) {
    ...
    uint32_t sub_id = rogue_event_subscribe_conditional(ROGUE_EVENT_ENTITY_CREATED,
                                                       test_event_callback_basic,
                                                       NULL, test_event_predicate, 1);
    assert(sub_id != 0);
...
static bool test_system_unsubscribe(void) {
    ...
    uint32_t sub1 = rogue_event_subscribe(ROGUE_EVENT_ENTITY_CREATED, test_event_callback_basic, NULL, 100);
    uint32_t sub2 = rogue_event_subscribe(ROGUE_EVENT_PLAYER_MOVED, test_event_callback_basic, NULL, 100);
    uint32_t sub3 = rogue_event_subscribe(ROGUE_EVENT_DAMAGE_DEALT, test_event_callback_basic, NULL, 101);
    ...
    assert(rogue_event_publish(ROGUE_EVENT_DAMAGE_DEALT, &payload,
                              ROGUE_EVENT_PRIORITY_NORMAL, 1, "Test") == true);
...
static bool test_event_processing_priority(void) {
    ...
    uint32_t sub_id = rogue_event_subscribe(ROGUE_EVENT_ENTITY_CREATED, test_event_callback_basic, NULL, 1);
    assert(sub_id != 0);
    ...
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_LOW, 1, "Low") == true);
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_CRITICAL, 1, "Critical") == true);
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_HIGH, 1, "High") == true);
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_NORMAL, 1, "Normal") == true);
    ...
    reset_test_state();
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_HIGH, 1, "HighOnly") == true);
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_LOW, 1, "LowOnly") == true);
...
static bool test_event_processing_retry(void) {
    ...
    uint32_t sub_id = rogue_event_subscribe(ROGUE_EVENT_ENTITY_CREATED, test_event_callback_failing, NULL, 1);
    assert(sub_id != 0);
    
    RogueEventPayload payload = create_test_payload(500);
    assert(rogue_event_publish(ROGUE_EVENT_ENTITY_CREATED, &payload,
                              ROGUE_EVENT_PRIORITY_NORMAL, 1, "RetryTest") == true);
...
static bool test_event_replay_recording(void) {
    ...
    for (int i = 0; i < 10; i++) {
        assert(rogue_event_publish(ROGUE_EVENT_PLAYER_MOVED, &payload,
                                  ROGUE_EVENT_PRIORITY_NORMAL, i + 100, "OverflowTest") == true);
    }
