...
static void load_basic_affixes()
{
    rogue_affixes_reset();
...
int main()
{
    ...
    inst.prefix_index = idx_bulwark;
    inst.prefix_value = 7; /* block chance */
    inst.suffix_index = idx_guarding;
    inst.suffix_value = 10; /* block value */
    ...
    g_player_stat_cache.block_chance += inst.prefix_value;
    g_player_stat_cache.block_value += inst.suffix_value;
