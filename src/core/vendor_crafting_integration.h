...
/* 8.3 Batch refinement service: vendor performs a refinement operation across multiple materials.
       Applies a gold service fee (percent of base value sum) and aggregates outcomes.
       Parameters:
...
/* 8.4 Scarcity feedback loop: record vendor-observed deficit for a material (e.g., many purchase attempts, few sales).
       This accumulates a simple deficit counter which gathering spawn weighting code may query.
       deficit_delta can be negative to reduce.
*/
