 ...
 *  0.2 Define canonical difficulty attributes: hp_budget, dps_budget, control_budget, mobility_budget
 *  0.3 Establish tier bands (Normal, Veteran, Elite, MiniBoss, Boss, Nemesis) with budget multipliers
 *  0.4 Reserve ID ranges for future special tiers (Mythic, Event) (not populated yet)
 *  0.5 Tests: uniqueness, multiplier table monotonicity
 *
 ...
 * Later phases will supply base curves -> apply tier multiplier -> relative ΔL model -> modifiers -> adaptive. */
