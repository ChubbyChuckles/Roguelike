...
typedef enum RogueAffixStat
{
    ...
    ROGUE_AFFIX_STAT_PHYS_CONV_FIRE_PCT,
    ROGUE_AFFIX_STAT_PHYS_CONV_FROST_PCT,
    ROGUE_AFFIX_STAT_PHYS_CONV_ARCANE_PCT,
    ROGUE_AFFIX_STAT_GUARD_RECOVERY_PCT,
    ROGUE_AFFIX_STAT_THORNS_PERCENT,
    ROGUE_AFFIX_STAT_THORNS_CAP,
