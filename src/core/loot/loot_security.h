...
extern "C"
{
     ...
     * produced, and arrays of item definition indices, quantities, and optional rarities (may be
     * NULL). Returns FNV1a-32 hash across all parameters. Deterministic across platforms. */
     ...
     * Provides a reversible (to parties with salt) mixed value using bit rotations + multiplicative
     * hashing. */
     ...
     * Returns 0 on success, <0 on error (file open failure or allocation). Stores internal
     * baseline. */
