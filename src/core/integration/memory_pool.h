...
#ifdef __cplusplus
extern "C" { // (Defensive; project is C-only.)
#endif
...
void rogue_memory_pool_shutdown(void); // releases all internal pages/arenas (leak report optional)
...
// Slab API --------------------------------------------------------------
// Register a slab class for objects of given size (<= 2048). page_obj_count (>=8) controls density.
