...
int rogue_loot_crafting_bridge_sort_material(RogueLootCraftingBridge* bridge,
                                             uint32_t item_id,
                                             RogueMaterialCategory category,
                                             uint16_t quantity,
...
int rogue_loot_crafting_bridge_queue_auto_craft(RogueLootCraftingBridge* bridge,
                                                uint32_t recipe_id,
                                                uint16_t quantity,
...
void rogue_loot_crafting_bridge_get_metrics(RogueLootCraftingBridge* bridge, char* out_buffer, size_t buffer_size);
