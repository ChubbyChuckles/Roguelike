...
bool rogue_config_update_schema_version(RogueConfigSchema* schema, 
...
RogueConfigValidationResult rogue_config_execute_migration(const char* config_file_path,
                                                           const RogueConfigVersion* target_version);

/* Create backup of configuration before migration */
bool rogue_config_create_backup(const char* config_file_path, char* backup_path, size_t backup_path_size);
...
void rogue_config_format_version_string(const RogueConfigVersion* version, char* output, size_t output_size);
