...
#define ROGUE_HOT_RELOAD_MAX_NOTIFICATIONS 128
    ...
    typedef void (*RogueReloadCallback)(const char* file_path, RogueReloadChangeType change_type,
                                        void* user_data);
    typedef bool (*RogueReloadValidator)(const char* file_path, const char* content,
                                         void* user_data);
    ...
    bool rogue_hot_reload_add_watcher(RogueHotReloadSystem* system, const char* path,
                                      bool recursive, RogueReloadCallback callback,
                                      void* user_data);
    ...
    /* Change Detection (2.4.2) */
    bool rogue_hot_reload_compute_file_hash(const char* file_path, char* hash_out,
                                            size_t hash_size);
    ...
    /* Staged Reloading (2.4.3) */
    bool rogue_hot_reload_set_validator(RogueHotReloadSystem* system,
                                        RogueReloadValidator validator, void* user_data);
    ...
    uint64_t rogue_hot_reload_begin_transaction(RogueHotReloadSystem* system, bool atomic,
                                                bool rollback_on_failure);
    bool rogue_hot_reload_add_file_to_transaction(RogueHotReloadSystem* system,
                                                  uint64_t transaction_id, const char* file_path);
    bool rogue_hot_reload_commit_transaction(RogueHotReloadSystem* system, uint64_t transaction_id);
    bool rogue_hot_reload_rollback_transaction(RogueHotReloadSystem* system,
                                               uint64_t transaction_id);
    ...
    /* Error Handling & Rollback (2.4.6) */
    bool rogue_hot_reload_set_rollback_directory(RogueHotReloadSystem* system,
    ...
    bool rogue_hot_reload_send_notification(RogueHotReloadSystem* system, const char* target_system,
                                            ...
                                            RogueReloadChangeType change_type, void* user_data);
    void rogue_hot_reload_process_notifications(RogueHotReloadSystem* system);
    void rogue_hot_reload_acknowledge_notification(RogueHotReloadSystem* system,
                                                   int notification_id);
    ...
    /* Statistics */
    void rogue_hot_reload_get_statistics(const RogueHotReloadSystem* system,
                                         uint64_t* files_watched, uint64_t* changes_detected,
                                         uint64_t* reloads_successful, uint64_t* reloads_failed,
                                         uint64_t* rollbacks_performed);
