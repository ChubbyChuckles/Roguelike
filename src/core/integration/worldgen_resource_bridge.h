...
#define RESOURCE_QUALITY_TIERS 10
    ...
    bool rogue_worldgen_resource_bridge_update(RogueWorldGenResourceBridge* bridge,
                                               float delta_time);
    ...
    uint32_t rogue_worldgen_resource_bridge_place_nodes(RogueWorldGenResourceBridge* bridge,
                                                        uint32_t region_id,
                                                        RogueBiomeType biome_type, float region_x,
                                                        float region_y, float region_width,
                                                        float region_height);
    ...
    bool rogue_worldgen_resource_bridge_add_seasonal_availability(
        RogueWorldGenResourceBridge* bridge, RogueResourceType resource_type,
        RogueSeasonType peak_season, const float* season_modifiers);
