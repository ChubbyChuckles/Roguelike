...
#define ROGUE_DEP_MAX_IMPACT_SYSTEMS 32
    ...
    typedef struct RogueImpactAnalysis
    {
        ...
        char affected_systems[ROGUE_DEP_MAX_IMPACT_SYSTEMS]
                             [ROGUE_DEP_MAX_NAME_LENGTH]; // Affected system names
    ...
    void rogue_dependency_manager_set_auto_resolve(RogueDependencyManager* manager,
                                                   bool auto_resolve);
    void rogue_dependency_manager_set_strict_mode(RogueDependencyManager* manager,
                                                  bool strict_mode);
    ...
    bool rogue_dependency_manager_remove_file(RogueDependencyManager* manager,
    ...
    bool rogue_dependency_manager_add_dependency(RogueDependencyManager* manager,
                                                 ...
                                                 RogueDependencyType type, int priority,
    ...
    int rogue_dependency_manager_get_dependencies(RogueDependencyManager* manager,
                                                  const char* source_file,
                                                  RogueDependency* dependencies,
                                                  int max_dependencies);

    // Dependency resolution functions
    bool rogue_dependency_manager_resolve_all(RogueDependencyManager* manager);
    bool rogue_dependency_manager_resolve_file(RogueDependencyManager* manager,
                                               const char* file_path);
    RogueDependencyStatus
    ...
    int rogue_dependency_manager_get_affected_files(
        RogueDependencyManager* manager, const char* changed_file,
