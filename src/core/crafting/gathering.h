 ...
 * id,material_table,
 * min_roll,max_roll,respawn_ms,tool_req_tier,biome_tags,spawn_chance_pct,rare_proc_chance_pct,rare_bonus_multiplier
...
#define ROGUE_GATHER_NODE_CAP 256
    ...
    /* Harvest node: returns 0 success, <0 error (-1 invalid, -2 depleted, -3 tool tier
     * insufficient). */
