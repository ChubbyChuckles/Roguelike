...
typedef struct RogueStatCache {
    ...
    /* Layer order: base -> implicit -> unique -> set -> runeword -> affix -> passives -> buffs -> total */
    int base_strength, implicit_strength, unique_strength, set_strength, runeword_strength, affix_strength, passive_strength, buff_strength, total_strength;
    int base_dexterity, implicit_dexterity, unique_dexterity, set_dexterity, runeword_dexterity, affix_dexterity, passive_dexterity, buff_dexterity, total_dexterity;
    int base_vitality, implicit_vitality, unique_vitality, set_vitality, runeword_vitality, affix_vitality, passive_vitality, buff_vitality, total_vitality;
    int base_intelligence, implicit_intelligence, unique_intelligence, set_intelligence, runeword_intelligence, affix_intelligence, passive_intelligence, buff_intelligence, total_intelligence;
