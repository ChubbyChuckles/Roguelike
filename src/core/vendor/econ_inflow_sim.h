 ...
 * Provides deterministic baseline estimates for expected material & item economic value inflow per
 * hour at a reference player performance (kills per minute) and average drops per kill. Initial
 * simple linear model; future phases can plug in richer loot table probability analytics.
 */
