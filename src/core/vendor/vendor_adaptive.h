/* Phase 9 Adaptive Vendor Behavior (purchase profile, preference adaptation, flip detection, batch gating) */
...
void rogue_vendor_adaptive_apply_category_weights(int* out_weights, const int* base_weights, int count);
