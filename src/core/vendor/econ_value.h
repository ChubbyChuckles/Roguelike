 ...
 * Formula: base_value * slot_factor(category) * rarity_multiplier * (1 + p/(p+20)) * (0.4 + 0.6*durability_fraction)
 * Clamped to [1,100000000]. Diminishing returns on affix power via p/(p+20).
 */
