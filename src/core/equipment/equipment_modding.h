...
extern "C"
{
    ...
    typedef struct RogueSandboxInstr
    {
        unsigned char op;
        unsigned char stat;
        int value;
    } RogueSandboxInstr; /* op:1=ADD,2=MUL */
    typedef struct RogueSandboxScript
    {
        int instr_count;
        RogueSandboxInstr instrs[16];
    } RogueSandboxScript;
    ...
    void rogue_script_apply(const RogueSandboxScript* s, int* strength, int* dexterity,
