...
enum RogueEquipAggregateMode { ROGUE_EQUIP_AGGREGATE_SCALAR=0, ROGUE_EQUIP_AGGREGATE_SIMD=1 };
...
int  rogue_equip_profiler_zone_stats(const char* name, double* total_ms, int* count); /* returns 0 on success */
