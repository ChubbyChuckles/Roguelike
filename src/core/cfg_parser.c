...
RogueCfgCategory rogue_cfg_classify_file(const char* filename) {
    if (!filename) return ROGUE_CFG_CATEGORY_MISC;
...
RogueCfgFormat rogue_cfg_detect_format(const char* filename) {
    if (!filename) return ROGUE_CFG_FORMAT_CSV;
...
RogueCfgFileAnalysis* rogue_cfg_analyze_file(const char* filename) {
    ...
    if (!file) {
        ...
        snprintf(analysis->validation_errors[analysis->validation_error_count++],
                sizeof(analysis->validation_errors[0]),
    ...
    ROGUE_LOG_INFO("Analyzed CFG file: %s (%s format, %d data lines)",
             filename, rogue_cfg_format_to_string(analysis->format), analysis->data_lines);
...
bool rogue_cfg_parse_key_value_line(const char* line, RogueCfgKeyValuePair* pair) {
    ...
    if (key_len >= sizeof(pair->key)) key_len = sizeof(pair->key) - 1;
...
RogueCfgParseResult* rogue_cfg_parse_file(const char* filename) {
    ...
    ROGUE_LOG_INFO("Parsed CFG file: %s (%s format, %s)",
             filename, rogue_cfg_format_to_string(result->detected_format),
...
const char* rogue_cfg_data_type_to_string(RogueCfgDataType type) {
    switch (type) {
        case ROGUE_CFG_DATA_TYPE_INTEGER: return "integer";
        case ROGUE_CFG_DATA_TYPE_FLOAT: return "float";
        case ROGUE_CFG_DATA_TYPE_STRING: return "string";
        case ROGUE_CFG_DATA_TYPE_ENUM: return "enum";
        case ROGUE_CFG_DATA_TYPE_BOOLEAN: return "boolean";
        case ROGUE_CFG_DATA_TYPE_PATH: return "path";
        case ROGUE_CFG_DATA_TYPE_ID: return "id";
...
const char* rogue_cfg_format_to_string(RogueCfgFormat format) {
    switch (format) {
        case ROGUE_CFG_FORMAT_CSV: return "CSV";
        case ROGUE_CFG_FORMAT_KEY_VALUE: return "Key-Value";
        case ROGUE_CFG_FORMAT_SECTIONED: return "Sectioned";
        case ROGUE_CFG_FORMAT_TABLE: return "Table";
        case ROGUE_CFG_FORMAT_HIERARCHICAL: return "Hierarchical";
        case ROGUE_CFG_FORMAT_LIST: return "List";
        default: return "Unknown";
    }
}
...
const char* rogue_cfg_category_to_string(RogueCfgCategory category) {
    switch (category) {
        case ROGUE_CFG_CATEGORY_ITEMS: return "Items";
        case ROGUE_CFG_CATEGORY_AFFIXES: return "Affixes";
        case ROGUE_CFG_CATEGORY_LOOT_TABLES: return "Loot Tables";
        case ROGUE_CFG_CATEGORY_TILES: return "Tiles";
        case ROGUE_CFG_CATEGORY_SOUNDS: return "Sounds";
        case ROGUE_CFG_CATEGORY_DIALOGUE: return "Dialogue";
        case ROGUE_CFG_CATEGORY_SKILLS: return "Skills";
        case ROGUE_CFG_CATEGORY_ENEMIES: return "Enemies";
        case ROGUE_CFG_CATEGORY_BIOMES: return "Biomes";
        case ROGUE_CFG_CATEGORY_MATERIALS: return "Materials";
        case ROGUE_CFG_CATEGORY_RESOURCES: return "Resources";
        case ROGUE_CFG_CATEGORY_UI: return "UI";
        case ROGUE_CFG_CATEGORY_ENCOUNTERS: return "Encounters";
        case ROGUE_CFG_CATEGORY_PLAYER: return "Player";
        case ROGUE_CFG_CATEGORY_MISC: return "Miscellaneous";
        default: return "Unknown";
    }
}
