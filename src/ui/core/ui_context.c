...
/* Skill graph API implemented in ui_skillgraph.c (kept here for linkage across TUs) */
...
/* Skill graph implementation moved to ui_skillgraph.c */
void rogue_ui_skillgraph_free_quadtree(void* qt); /* internal helper from ui_skillgraph.c */
