...
static const char *level_to_str(RogueLogLevel lvl) {
    switch (lvl) {
        case ROGUE_LOG_DEBUG_LEVEL: return "DEBUG";
        case ROGUE_LOG_INFO_LEVEL: return "INFO";
        case ROGUE_LOG_WARN_LEVEL: return "WARN";
        case ROGUE_LOG_ERROR_LEVEL: return "ERROR";
        default: return "?";
    }
}
