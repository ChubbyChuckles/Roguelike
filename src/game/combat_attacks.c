...
static const RogueAttackDef g_thrust_chain[] = {
    ...
    {1,"thrust_2",ROGUE_WEAPON_THRUST,1,125,60,115,14,14,8,0,0.15f,0.35f,0.00f,1,{{0,60}}, 0.0f, (ROGUE_CANCEL_ON_HIT|ROGUE_CANCEL_ON_WHIFF), 0.45f, 0.9f, 0.0f},
};
static const RogueAttackDef g_ranged_chain[] = {
    {0,"ranged_1",ROGUE_WEAPON_RANGED,0,140,40,100,10,0,4,0,0.05f,0.30f,0.00f,1,{{0,40}}, 0.0f, (ROGUE_CANCEL_ON_HIT|ROGUE_CANCEL_ON_WHIFF), 0.35f, 0.0f, 0.6f},
    {1,"ranged_2",ROGUE_WEAPON_RANGED,1,150,50,110,12,0,5,0,0.05f,0.34f,0.00f,1,{{0,50}}, 0.0f, (ROGUE_CANCEL_ON_HIT|ROGUE_CANCEL_ON_WHIFF), 0.35f, 0.0f, 0.7f},
};
static const RogueAttackDef g_spell_chain[] = {
    {0,"spell_1",ROGUE_WEAPON_SPELL_FOCUS,0,160,60,140,16,0,9,3,0.00f,0.00f,0.40f,1,{{0,60}}, 0.0f, (ROGUE_CANCEL_ON_HIT|ROGUE_CANCEL_ON_WHIFF), 0.40f, 0.0f, 1.8f},
};
