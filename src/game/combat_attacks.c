...
static const RogueAttackDef g_light_chain[] = {
    {0,"light_1",ROGUE_WEAPON_LIGHT,0,110,70,120,14,10,5,0,0.25f,0.10f,0.00f,1,{{0,70}}},
    {1,"light_2",ROGUE_WEAPON_LIGHT,1,95, 65,115,12,12,6,0,0.27f,0.12f,0.00f,1,{{0,65}}},
    {2,"light_3",ROGUE_WEAPON_LIGHT,2,105,75,140,16,15,8,0,0.30f,0.14f,0.00f,1,{{0,75}}},
};
static const RogueAttackDef g_heavy_chain[] = {
    {0,"heavy_1",ROGUE_WEAPON_HEAVY,0,170,90,180,24,28,14,0,0.45f,0.05f,0.00f,1,{{0,90}}},
    {1,"heavy_2",ROGUE_WEAPON_HEAVY,1,190,105,200,28,35,18,0,0.50f,0.05f,0.00f,1,{{0,105}}},
};
static const RogueAttackDef g_thrust_chain[] = {
    {0,"thrust_1",ROGUE_WEAPON_THRUST,0,120,55,110,13,12,7,0,0.20f,0.20f,0.00f,1,{{0,55}}},
    {1,"thrust_2",ROGUE_WEAPON_THRUST,1,125,60,115,14,14,8,0,0.22f,0.22f,0.00f,1,{{0,60}}},
};
static const RogueAttackDef g_ranged_chain[] = {
    {0,"ranged_1",ROGUE_WEAPON_RANGED,0,140,40,100,10,0,4,0,0.05f,0.30f,0.00f,1,{{0,40}}},
    {1,"ranged_2",ROGUE_WEAPON_RANGED,1,150,50,110,12,0,5,0,0.05f,0.34f,0.00f,1,{{0,50}}},
};
static const RogueAttackDef g_spell_chain[] = {
    {0,"spell_1",ROGUE_WEAPON_SPELL_FOCUS,0,160,60,140,16,0,9,3,0.00f,0.00f,0.40f,1,{{0,60}}},
};
