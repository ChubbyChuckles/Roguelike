...
static const RogueAttackDef g_heavy_chain[] = {
    ...
    {1,"heavy_2",ROGUE_WEAPON_HEAVY,1,190,105,200,28,35,18,0,0.50f,0.05f,0.00f,3,{{0,40,ROGUE_CANCEL_ON_HIT,0.55f,0.0f,0.00f,-1,-1},{40,80,ROGUE_CANCEL_ON_HIT,0.85f,0.03f,0.00f,-1,-1},{80,105,ROGUE_CANCEL_ON_HIT,1.25f,0.06f,0.02f,-1,-1}}, 0.0f, (ROGUE_CANCEL_ON_HIT), 0.65f, 4.0f, 0.0f},
};
