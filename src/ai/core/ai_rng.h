...
extern "C"
{
    ...
    static inline void rogue_ai_rng_seed(RogueAIRNG* r, uint64_t seed)
    {
        if (r)
    ...
    static inline float rogue_ai_rng_next_float(RogueAIRNG* r)
    {
        return (rogue_ai_rng_next_u32(r) / 4294967296.0f);
    }
